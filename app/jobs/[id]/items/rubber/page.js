...
export default function RubberEstimatorPage() {
  ...
  const { addItem, setCurrentJob } = useJob()
            ...
            {selectedRubber ? (
              <div className="flex items-center justify-between gap-aq-md">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-caption text-aq-muted">{formatCurrency(selectedRubber.sell_price)}/{selectedRubber.unit || 'm'}</p>
                </div>
                  ...
                  <div className="flex flex-col gap-aq-sm">
                    ...
                    {selectedRubber && (
                      <div className="flex justify-between">
                        ...
                        <span className="text-secondary text-aq-ink">{formatCurrency(totals.partsCost)}</span>
                      </div>
                    )}
                    <div className="h-px bg-aq-border my-aq-xs" />
                    <div className="flex justify-between">
                      <span className="text-body font-medium text-aq-ink">Line total</span>
                      <span className="text-body font-medium text-aq-ink">{formatCurrency(totals.lineTotal)}</span>
                    </div>
                  </div>
                </div>
              )}
